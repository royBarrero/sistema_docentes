...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('coordinador.horarios.create') }}" class="btn btn-primary">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('coordinador.horarios.index') }}" class="row g-3">
                <div class="col-md-3">
                    ...
                    <tbody>
                        @forelse ($horarios as $horario)
                            <tr>
                                ...
                                <td>
                                    <span class="badge {{ $horario->estado == 'Activo' ? 'bg-success' : 'bg-secondary' }}">
                                        {{ $horario->estado }}
                                    </span>
                                </td>
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <form action="{{ route('coordinador.horarios.destroy', $horario->id) }}" 
                                              method="POST" 
                                              class="d-inline"
