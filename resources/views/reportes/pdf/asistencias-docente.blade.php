...
<head>
    ...
    <title>Reporte de Asistencias - {{ $docente->usuario->nombre_completo }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="stats">
        ...
        <div class="stat-item">
            <strong>{{ $estadisticas['porcentaje_asistencia'] }}%</strong>
        ...
        <tbody>
            @foreach($asistencias as $asistencia)
                <tr>
                    ...
                    <td>{{ \Carbon\Carbon::parse($asistencia->fecha)->locale('es')->isoFormat('dddd') }}</td>
                    ...
                    <td>
                        {{ $asistencia->hora_registro ? \Carbon\Carbon::parse($asistencia->hora_registro)->format('H:i:s') : '-' }}
                    </td>
                    <td>
