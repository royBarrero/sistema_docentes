                        ...
                        <form action="{{ route('usuarios.update', $usuario->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" name="telefono"
                                    ...
                                    value="{{ old('telefono', $docente->telefono ?? '') }}" pattern="[0-9]+"
                                    title="Solo se permiten números" maxlength="15"
                            ...
                            <div class="mb-3">
                                <label for="password" class="form-label">Nueva Contraseña (dejar en blanco para mantener la
                                    actual)</label>
